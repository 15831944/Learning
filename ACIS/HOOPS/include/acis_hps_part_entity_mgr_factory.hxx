...
#ifndef acis_hps_part_entity_mgr_FACTORY_CLASS
#define acis_hps_part_entity_mgr_FACTORY_CLASS
...
/**
 * @file acis_hps_part_entity_mgr_factory.hxx
 * @CAA2Level L1
 * @CAA2Usage U1
 *! \addtogroup HPSBRIDGEAPI
 *  \brief Declared at <acis_hps_part_entity_mgr_factory.hxx>
 *  @{
 */
...
class DECL_HPS_PART acis_hps_part_entity_mgr_factory : public acis_pm_entity_mgr_factory
{
protected:
	/**
	 * @nodoc
...
public:
	 ...
	 * Default constructor.
	 * <br><br>
	 * <b>Role:</b> Constructs an <tt>acis_hps_part_entity_mgr_factory</tt> object.  A list of <tt>PART</tt>
	 ...
	 */
	acis_hps_part_entity_mgr_factory( const VOID_LIST& seed_parts = *(VOID_LIST*)NULL_REF );
};

/*! @} */
#endif // acis_hps_part_entity_mgr_FACTORY_CLASS
