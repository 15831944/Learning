...
#if defined( __ha_part ) || defined( __SpaHPart )
...
#  define DECL_HA_PART EXPORT_SYMBOL
# else
#  define DECL_HA_PART IMPORT_SYMBOL
# endif
#else
# define DECL_HA_PART
#endif
...
#    define spa_lib_name "ha_part"
#   else
#    define spa_lib_name "SpaHPart"
#   endif
