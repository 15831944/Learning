...
/*******************************************************************/
#ifndef DECL_HPS_PART

#if defined( __hps_part ) || defined( __SpaHpsPart )
...
#		define DECL_HPS_PART EXPORT_SYMBOL
#	else
#		define DECL_HPS_PART IMPORT_SYMBOL
#	endif
#else
#	define DECL_HPS_PART
#endif
...
#               define spa_lib_name "hps_part"
#           else
#               define spa_lib_name "SpaHpsPart"
#           endif
