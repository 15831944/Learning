...
#if defined( __hps_bridge ) || defined( __SpaHpsBridge )
...
#		define DECL_HPS EXPORT_SYMBOL
#	else
#		define DECL_HPS IMPORT_SYMBOL
#	endif
#else
#	define DECL_HPS
#endif
...
#			define spa_lib_name "hps_bridge"
#			else
#				define spa_lib_name "SpaHPSBridge"
#			endif
