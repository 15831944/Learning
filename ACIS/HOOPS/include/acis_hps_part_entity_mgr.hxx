...
#ifndef acis_hps_part_entity_mgr_CLASS
#define acis_hps_part_entity_mgr_CLASS
...
/**
 * @file acis_hps_part_entity_mgr.hxx
 * @CAA2Level L1
 * @CAA2Usage U1
 *! \addtogroup HPSBRIDGEAPI
 *  \brief Declared at <acis_hps_part_entity_mgr.hxx>
 *  @{
 */
 ...
 * <br><br>
 * <b>Role:</b> The <tt>acis_hps_part_entity_mgr</tt> (and its corresponding factory) is used to
 * integrate ACIS Assembly Modeling with the Scheme example application.  The implementations of <tt>acis_hps_part_entity_mgr</tt>
 * and <tt>acis_hps_part_entity_mgr_factory</tt> are provided as example code.
 * Please refer to the assembly modeling technical articles for further details.
 * <br>
 * @see acis_pm_entity_mgr, acis_hps_part_entity_mgr
 */
class DECL_HPS_PART acis_hps_part_entity_mgr : public acis_pm_entity_mgr
{
...
protected:
	 ...
	 * @nodoc
	 */
	virtual acis_hps_part_entity_mgr* acis_hps_part_cast_vf();
	/**
	 * @nodoc
	 */
	 ...
	 * @nodoc
	 */
	virtual void* hps_part_customer_cast_vf();
...
public:
	 ...
	 * Default constructor.
	 * <br><br>
	 * <b>Role:</b> Constructs an unbound <tt>acis_hps_part_entity_mgr</tt> object.
	 * If a <tt>PART</tt> object is specified, it will be bound to the new entity manager.
	 * <br><br>
	 * @param part
	 * part to be bound.
	 */
	acis_hps_part_entity_mgr( PART* part = NULL );
...
/*! @} */
#endif // acis_hps_part_entity_mgr_CLASS
