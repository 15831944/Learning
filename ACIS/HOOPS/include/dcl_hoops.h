...
#if defined( __ha_bridge ) || defined( __SpaHBridge )
...
#  define DECL_HOOPS EXPORT_SYMBOL
# else
#  define DECL_HOOPS IMPORT_SYMBOL
# endif
#else
# define DECL_HOOPS
#endif
...
#    define spa_lib_name "ha_bridge"
#   else
#    define spa_lib_name "SpaHBridge"
#   endif
